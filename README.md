...
This network implements a Delay Tolerant Networking (DTN) model over a Fog computing architecture. Data is processed at the edge (Fog nodes) and forwarded via the Bundle Protocol to the B-lan main server.
Routing Logic
...
Installation Instructions
    ...
    Upload the generated configure_blan.sh script.
    Run chmod +x configure_blan.sh.
    Execute ./configure_blan.sh.
    Reboot the router.
